...
nombre_completo = str(input("Escriba su nombre completo: "))

minuscula = str.lower(nombre_completo)
print(minuscula)
mayuscula = str.upper(nombre_completo)
print(mayuscula)
inicial = str.capitalize(nombre_completo[0])
print(inicial)
